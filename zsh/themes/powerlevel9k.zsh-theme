...
POWERLEVEL9K_DIR_PATH_SEPARATOR="%F{007}/%F{cyan}"
...
POWERLEVEL9K_SWIFT_VERSION_FOREGROUND='081'
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status go_version swift_version nvm os_icon)
POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR=''
POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%F{007}\uf104%F{7}'
